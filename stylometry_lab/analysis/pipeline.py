...
def run_analysis(
    ...
    # Extract global stylistic features (if extract_features function exists)
    global_featuresA = {}
    global_featuresB = {}
    global_featuresU = {}
    ...
    try:
        if textA and textA.strip():
            global_featuresA = features.extract_features(textA)
        if textB and textB.strip():
            global_featuresB = features.extract_features(textB)
        if textU and textU.strip():
            global_featuresU = features.extract_features(textU)
    ...
    return {
        ...
        "global_featuresA": global_featuresA,
        "global_featuresB": global_featuresB,
        "global_featuresU": global_featuresU,
    }    apply_A, apply_B, apply_U,
    custom_stopwords_text,
    exclusion_words_frozen,
    chunk_mode, selected_topics, min_conf,
